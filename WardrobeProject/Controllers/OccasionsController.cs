...
namespace WardrobeProject.Controllers
{
    public class OccasionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccasionsID,OccasionsName")] Occasion occasion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccasionsID,OccasionsName")] Occasion occasion)
        {
            if (ModelState.IsValid)
            {
