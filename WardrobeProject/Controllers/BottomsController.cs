...
namespace WardrobeProject.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "bottomID,bottomItemName,photo")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "bottomID,bottomItemName,photo")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
