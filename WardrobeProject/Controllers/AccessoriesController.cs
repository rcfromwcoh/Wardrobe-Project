...
namespace WardrobeProject.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "accessoryID,accessoryItemName,photo")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "accessoryID,accessoryItemName,photo")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
